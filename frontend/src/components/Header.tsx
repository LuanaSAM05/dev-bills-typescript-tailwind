                ...
                <div className="flex justify-between items-center py-4">
                    ...
                    <div className="hidden md-flex items-center space-x-4">
                        {isAuthenticated ? (
                            ...
                            <Link to="/login">
                                <LogIn className="bg-primary-500 text-gray-900 font-semibold px-5 py-2.5 rounded-xl flex items-center justify-center hover:bg-primary-500" />
                                Entrar
                            </Link>
                        )}
                    </div>
                            ...
                            <>
                                    ...
                                    {navLink.map((link) => (
                                        <Link
                                            ...
                                            className={` block p-5 rounded-lg
                                                ${location.pathname === link.path
                                                    ? "text-primary-500  bg-primary-800 font-medium"
                                                    : "text-gray-400 hover:text-primary-500 hover:bg-primary-800"} 
                                            }`}
                                ...
                                <div className="flex items-center justify-between p-4 border-t border-gray-700">
                                    ...
                                    <button
                                        type="button"
                                        onClick={handleSignOut}
                                        className=" text-gray-400 hover:text-red-700 hover:bg-red-500 p-2 rounded-full transition-colors cursor-pointer"
                                    >
                                        <LogOut size={20} />
                                    </button>
                                </div>
